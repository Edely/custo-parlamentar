...
var version=$$$1.fn.jquery.split(' ')[0].split('.');var minMajor=1;var ltMajor=2;var minMinor=9;var minPatch=1;var maxMajor=4;if(version[0]<ltMajor&&version[1]<minMinor||version[0]===minMajor&&version[1]===minMinor&&version[2]<minPatch||version[0]>=maxMajor){throw new Error('Bootstrap\'s JavaScript requires at least jQuery v1.9.1 but less than v4.0.0');}})($);exports.Util=Util;exports.Alert=Alert;exports.Button=Button;exports.Carousel=Carousel;exports.Collapse=Collapse;exports.Dropdown=Dropdown;exports.Modal=Modal;exports.Popover=Popover;exports.Scrollspy=ScrollSpy;exports.Tab=Tab;exports.Tooltip=Tooltip;Object.defineProperty(exports,'__esModule',{value:true});})));var menu=(function(){var depu='.deputados__item';var sear="#procurar";var depuM='.deputados__item__mobile';var searM="#searchMobile";function listaDeputados(cssDeputados,searchId,mobile=false){var deputados=$(cssDeputados);var search=$(searchId)[0];$(searchId).on('input',function(){$(deputados).parent().css('display','none');var exp=new RegExp(search.value,'i');for(var j=0;j<deputados.length;j++){var depWrapper=deputados[j];var dep=$(depWrapper).text();if(dep.search(exp)!=-1){$(depWrapper).parent().css('display','block');}}});}
listaDeputados(depuM,searM);listaDeputados(depu,sear);$("#searchMobile").on('focus',function(){if(!$('#navbarMobDeputado').hasClass('show')){$('#navbarMobDeputado').addClass('show')
$('#navbarMobDeputado').addClass('collapsed');}});$("#searchMobile").on('blur',function(){$('.deputados-mobile button').click();if(!$('#searchMobile').val()==""){$('#navbarMobDeputado').removeClass('show');$('#navbarMobDeputado').removeClass('collapsed');}});})();(function(){$('.aside-desktop *').mouseover(function(){if(($(window).innerWidth()<992)&&($(window).innerWidth()>767)){$('.expand-menu').css('width','230px');$('.deputados__item').css('display','block');console.log('foi o hover');}});$('.aside-desktop *').mouseleave(function(){if(($(window).innerWidth()<992)&&($(window).innerWidth()>767)){$('.deputados__item').css('display','none');$('.expand-menu').css('width','64px');console.log('saiu o hover');}});})();console.log(1)